...
namespace FinalYear {
    ...
    public class LoadingBar : MonoBehaviour {
        ...
        private const float _paddingValue = 0.15f;    // asynchronous load ends at 0.1f, pad the value so the bar fills out correctly
        ...
        public void UpdateProgress(float progressValue) {
            if (_slider != null) {
                _targetProgressValue = progressValue + _paddingValue;
            }
        }
